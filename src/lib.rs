...
#[derive(Debug)]
pub struct PassportAuthProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PassportAuthProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PassportAuth processing");
    
    let mut processor = PassportAuthProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PassportAuthProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PassportAuthProcessor::new(false);
